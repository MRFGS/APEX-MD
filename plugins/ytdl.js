...
cmd({
  ...
  try {
    ...
    let _0x3d4fc8 = "\n*──────────────────*\n_*🌸 ALEXA VIDEO ＤＯＷＮＬＯＤＥＲ 🌸*_\n*──────────────────*\n\n🌸 *Title :* " + _0x49d7ef.title + "\n\n🌸 *Description :* " + _0x49d7ef.description + "\n\n🌸 *Duration :* " + _0x49d7ef.timestamp + "\n\n🌸 *Ago :* " + _0x49d7ef.ago + "\n\n🌸 *Views :* " + _0x49d7ef.views + "\n\n🌸 *URL :* " + _0x49d7ef.url + "\n\n_📤ᴜᴘʟᴏᴅɪɴɢ ʏᴏᴜʀ ᴀᴜᴅɪᴏ ꜰɪʟʟ📤_\n\n\n> ALEXA-MD\n";
